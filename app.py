...
if __name__ == "__main__":
    ...
    try:
        demo.launch(server_name=server_name, server_port=server_port, share=False, show_error=True, show_api=False)
    except ValueError as e:
        if "localhost is not accessible" in str(e):
            try:
                demo.launch(server_name=server_name, server_port=server_port, share=True, show_error=True, show_api=False)
            except OSError as oe:
                if "Cannot find empty port" in str(oe):
                    demo.launch(server_name=server_name, server_port=None, share=True, show_error=True, show_api=False)
                else:
                    raise
        else:
            raise
        ...
        if "Cannot find empty port" in str(e):
            demo.launch(server_name=server_name, server_port=None, share=False, show_error=True, show_api=False)
        else:
            raise
